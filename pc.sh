...
sleep 3
sudo docker pull ghcr.io/drosera-network/drosera-operator:latest || true
sleep 3
source ~/.bashrc || true
...
sudo docker compose up -d || { echo "Warning: Failed to start Docker containers, continuing..."; true; }
sleep 3
source ~/.bashrc
cd ~/my-drosera-trap || { echo "Error: Cannot change to ~/my-drosera-trap directory."; exit 1; }
...
sudo pkill -f drosera-operator || { echo "Warning: Failed to stop drosera-operator processes, continuing..."; true; }
sleep 3
source ~/.bashrc
cd ~/my-drosera-trap || { echo "Error: Cannot change to ~/my-drosera-trap directory."; exit 1; }
source ~/.bashrc
...
echo "============================================================="
echo "Drosera Network Testnet Setup Complete for Operator!"
echo "Check the Drosera dashboard at https://app.drosera.io/ for green blocks indicating node liveness."
echo "Follow me on Twitter for updates: https://x.com/whalepiz_"
echo "============================================================="
